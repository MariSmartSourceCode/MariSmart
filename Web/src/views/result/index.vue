<template>
    <div class="dashboard-container">
        <div class="back">
            <div class="content">
                <div class="title">检 测 结 果</div>
                <el-divider v-if="ifClass1"></el-divider>
                <div v-if="ifClass1" class="classTitle">工作流正确性性质</div>
                <div
                ...
                >
                    <el-row>
                        ...
                        <el-col :span="23">
                            ...
                            <div class="desc">规范：{{ item.prop }}</div>
                            <div class="desc">
                                耗时：{{ result[index].time }} ms
                            </div>
                            <div
                ...
                <div v-if="ifClass2" class="classTitle">支付正确性性质</div>
                <div
                ...
                <div v-if="ifClass3" class="classTitle">异常处理正确性性质</div>
                <div
                ...
                <div v-if="ifDiy" class="classTitle">自定义性质</div>
                <div
                ...
                >
                    <el-row>
                        ...
                        <el-col :span="23">
                            ...
                            <div class="desc">规范：{{ item.prop }}</div>
                            <!-- <div class="desc">耗时：{{ result[index+6].time }} ms</div>
                                <div v-if="result[index+6].result == 'false'" class="desc" style="5px;">
                                    <el-button plain class="example" size="mini" @click="showExample(result[index+6])">查看反例</el-button>
                                </div> -->
                        </el-col>
                    </el-row>
                </div>
