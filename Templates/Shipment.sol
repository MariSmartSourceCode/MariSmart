...
contract Shipment is IShipment {
    ...
    function inspect() external virtual override pre_inspect {
    ...
    /* Getters */
    function getShipper() external view virtual override returns (address) {
        return shipper;
    }

    function getCarrier() external view virtual override returns (address) {
        return carrier;
    }

    function getConsignee() external view virtual override returns (address) {
        return consignee;
    }
    ...
    function getQuantity() external view virtual override returns (uint) {
        return quantity;
    }

    function getWeight() external view virtual override returns (uint) {
        return weight;
    }

    function getVolume() external view virtual override returns (uint) {
        return volume;
    }

    function getPrice() external view virtual override returns (uint) {
        return price;
    }

    function getDownPayment() external view virtual override returns (uint) {
        return down_payment;
    }
    ...
    function getDepartDate() external view virtual override returns (uint) {
        return depart_date;
    }

    function getArriveDate() external view virtual override returns (uint) {
        return arrive_date;
    }

    function getSignValid() external view virtual override returns (uint) {
        return sign_valid;
    }

    function getReceiveValid() external view virtual override returns (uint) {
    ...
    function getCreateTime() external view virtual override returns (uint) {
        return create_time;
    }

    function getDepartTime() external view virtual override returns (uint) {
        return depart_time;
    }

    function getArriveTime() external view virtual override returns (uint) {
        return arrive_time;
    }

    function getIsDelayed() external view virtual override returns (bool) {
        return is_delayed;
    }

    function getIsDamaged() external view virtual override returns (bool) {
        return is_damaged;
    }
